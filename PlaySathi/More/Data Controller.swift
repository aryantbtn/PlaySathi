...
class DataController{
    ...
    static var venueData: [Venue] = [
        Venue(id: UUID(), name: "Sai Sports Academy", imageUrl: "v13", rating: 4.0, distanceInKm: 5, location: "Noida", numberOfCourts: ["Court1","Court2","Court3","Court4","Court1","Court2","Court3","Court4","Court1","Court2","Court3","Court4"], price: 230, amenities: ["Parking","Swimming Pool","Changing Room", "Water"],openingTime: "FSER",closingTime: "2", timeSlots: ["2PM-3PM","6PM-8PM","9PM-10PM","5PM-6PM"]),
