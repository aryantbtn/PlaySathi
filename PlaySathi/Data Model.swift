...
class ScreenData{
    ...
    static var userData: [User] = [
        User(id: 10, name: "Amitabh", profilePicture: "images6", elitePoints: 400, skillLevel: .advanced, location: 25),
        User(id: 11, name: "Shubham", profilePicture: "images7", elitePoints: 500, skillLevel: .advanced, location: 30),
        User(id: 12, name: "Shivam", profilePicture: "images8", elitePoints: 600, skillLevel: .advanced, location: 35),
        User(id: 13, name: "Kunal", profilePicture: "images9", elitePoints: 529, skillLevel: .advanced, location: 40),
        User(id: 14, name: "Vishal", profilePicture: "images10", elitePoints: 438, skillLevel: .advanced, location: 45),
        User(id: 15, name: "Jatin", profilePicture: "images11", elitePoints: 502, skillLevel: .advanced, location: 50),
        User(id: 16, name: "Amit", profilePicture: "images12", elitePoints: 488, skillLevel: .advanced, location: 55),
        User(id: 4, name: "Alok Kumar", profilePicture: "images4", elitePoints: 633, skillLevel: .advanced, location: 3.2),
        User(id: 5, name: "Umesh Gaur", profilePicture: "images1", elitePoints: 442, skillLevel: .beginner, location: 4),
        User(id: 6, name: "Rishabh Rathore", profilePicture: "images2", elitePoints: 400, skillLevel: .beginner, location: 7.4),
        User(id: 7, name: "Rohit Dixit", profilePicture: "images3", elitePoints: 492, skillLevel: .beginner, location: 9),
        User(id: 8, name: "Ankit Mishra", profilePicture: "Image", elitePoints: 594, skillLevel: .beginner, location: 10.7),
        User(id: 9, name: "Piyush Maurya", profilePicture: "images5", elitePoints: 644, skillLevel: .advanced, location: 20),
        User(id: 17, name: "Rohit", profilePicture: "images13", elitePoints: 465, skillLevel: .advanced, location: 60),
        User(id: 18, name: "Shubham", profilePicture: "images14", elitePoints: 443, skillLevel: .advanced, location: 65),
        User(id: 19, name: "Amit", profilePicture: "images15", elitePoints: 562, skillLevel: .advanced, location: 70),
        User(id: 20, name: "Amit", profilePicture: "images16", elitePoints: 442, skillLevel: .advanced, location: 75),
        User(id: 21, name: "Amit", profilePicture: "images17", elitePoints: 452, skillLevel: .advanced, location: 80),
        User(id: 22, name: "Amit", profilePicture: "images18", elitePoints: 462, skillLevel: .advanced, location: 85),
    ]
